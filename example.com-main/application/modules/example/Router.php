...
class ExampleRouter extends \Phalcon\Mvc\Router\Group {
    ...
    public function initialize () {
        ...
        if (ENV_MODE === true) {
            $config = new \Phalcon\Config\Adapter\Php(APP_PATH . '/commons/client/routers.php');
        } else {
            $config = new \Phalcon\Config\Adapter\Php(APP_PATH . '/commons/server/routers.php');
        }
